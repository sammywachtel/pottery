...
sample_item_internal_1 = PotteryItem(id=TEST_ITEM_ID_1, name="Test Mug", clayType="Stoneware", createdDateTime=NOW_UTC, createdTimezone="UTC", location="Studio", photos=[sample_photo_internal], user_id="admin")
sample_item_internal_2 = PotteryItem(id=TEST_ITEM_ID_2, name="Test Bowl", clayType="Porcelain", createdDateTime=NOW_UTC, createdTimezone="-04:00", location="Shelf", photos=[], user_id="admin")
...
async def test_create_item_success(client: TestClient, mocker, auth_headers):
    ...
    created_item_internal = PotteryItem(id=str(uuid.uuid4()), **internal_data_payload, createdTimezone=get_timezone_identifier(dt_object), photos=[], user_id="admin")
...
async def test_update_item_success(client: TestClient, mocker, auth_headers):
    ...
    updated_item_internal = PotteryItem(id=TEST_ITEM_ID_1, **internal_update_data, createdTimezone=get_timezone_identifier(dt_object), photos=[], user_id="admin")
